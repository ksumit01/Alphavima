            ...
            var placeholders = new Dictionary<string, string>
{
    ...
    <entity name='avpx_rentalreservation' >
        ...
        public List<string[]> RetrieveAndReturnRecords(IOrganizationService service, ITracingService tracingService, string rentalReservationId)
        {
            ...
            decimal totalLocalDamageWaiverAmount = 0;
    ...
    <entity name='avpx_rentalorderlineitem' >
        ...
        <link-entity name='avpx_rentalreservation' from='avpx_rentalreservationid' to='avpx_rentalreservation' link-type='inner' alias='al' >
            <attribute name='avpx_damagewaiverpercentage' />
                ...
                if (entityCollection.Entities.Count > 0)
                {
                    foreach (Entity entity in entityCollection.Entities)
                    {
                        ...
                        tracingService.Trace($"Display Name: {displayName} Description Name {description}");
                        ...
                        if (isDamageWaiverApplicable && avpxType != "Charge")
                        {
                            ...
                            totalLocalDamageWaiverAmount += localDamageWaiverAmount;
                        }
                        else
                        {
                    ...
                    tracingService.Trace("Subtotal Rentals: {0}, Subtotal Charges: {1}, Total Taxes: {2}, Calculated Total Amount: {3}, Total Damage Waiver Amount: {4}",
                    localSubtotalRentals, localSubtotalCharges, localTotalTaxes, localTotalAmount, totalLocalDamageWaiverAmount);
                }
                else
                {
            ...
            damageWaiverAmount = FormatWithCurrency(totalLocalDamageWaiverAmount, currencySymbol);
