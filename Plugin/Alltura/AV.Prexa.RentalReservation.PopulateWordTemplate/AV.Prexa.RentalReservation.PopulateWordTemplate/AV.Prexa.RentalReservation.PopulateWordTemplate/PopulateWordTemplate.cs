            ...
            var placeholders = new Dictionary<string, string>
{
    ...
    <entity name='avpx_rentalreservation' >
        ...
        <attribute name='av_allturadetrabjo' />
        ...
        <link-entity name='account' from='accountid' to='avpx_serviceaccount' link-type='inner' alias='ac' >
            ...
            <attribute name='paymenttermscode' />
                ...
                string GetAliasedValueOrDefault(string attribute, string defaultValue = "")
                {
                    try
                    {
                        if (rentalReservation.Contains(attribute) && rentalReservation[attribute] is AliasedValue aliasedValue)
                        {
                ...
                DateTime estimatedStartDateUtc = DateTime.Parse(GetValueOrDefault("avpx_estimatestartdate", DateTime.UtcNow.ToString("o")));
                DateTime estimatedEndtDateUtc = DateTime.Parse(GetValueOrDefault("avpx_estimateenddate", DateTime.UtcNow.ToString("o")));
                ...
                DateTime estimatedStartDateUtcLocal = GetLocalTime(estimatedStartDateUtc,userTimeZone, service, tracingService);
                DateTime estimatedEndtDateUtcToLocal = GetLocalTime(estimatedEndtDateUtc, userTimeZone, service, tracingService);
                ...
                tracingService.Trace($"Printed Estimated Start Date (Local): {estimatedStartDateUtcLocal}");
                ...
                if (rentalReservation.Contains("ac.paymenttermscode"))
                {
                    ...
                    {
                        case 10:
                            placeholders["pxPaymentTerms"] = "10 Days";
                            break;
                        case 15:
                            placeholders["pxPaymentTerms"] = "15 Days";
                            break;
                        case 20:
                            placeholders["pxPaymentTerms"] = "20 Days";
                            break;
                        case 30:
                            placeholders["pxPaymentTerms"] = "30 Days";
                            break;
                        case 45:
                            placeholders["pxPaymentTerms"] = "45 Days";
                            break;
                        case 60:
                            placeholders["pxPaymentTerms"] = "60 Days";
                            break;
                        case 783090000:
                ...
                placeholders["pxSDate"] = estimatedStartDateUtcLocal.ToString("dd/MM/yyyy");
                placeholders["pxEDate"] = estimatedEndtDateUtcToLocal.ToString("dd/MM/yyyy");
                ...
                placeholders["pxAldeTra"] = GetFormattedValueOrDefault("av_allturadetrabjo");
