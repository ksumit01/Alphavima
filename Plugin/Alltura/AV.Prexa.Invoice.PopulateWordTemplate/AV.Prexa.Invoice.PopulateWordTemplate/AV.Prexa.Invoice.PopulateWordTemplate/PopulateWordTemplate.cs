        ...
        <fetch version='1.0' output-format='xml-platform' mapping='logical' distinct='false'>
            <entity name='avpx_invoice'>
               ...
               /* DateTime invoiceDateUtc;
                if (!DateTime.TryParseExact(GetValueOrDefault("avpx_invoicedate"), "o", CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind, out invoiceDateUtc))
                {
                    invoiceDateUtc = DateTime.UtcNow; // Fallback to current UTC if parsing fails
                }*/
                ...
                //placeholders["pxEffectiveTo"] = invoiceDateUtcLocal.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
                ...
                else if(orderType == 783090001) //sale
                {
                    ...
                    placeholders["pxCuit"] = GetAliasedValueOrDefault("ac.av_cuit");
                }
